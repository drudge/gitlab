...
Project.prototype.listVariables = function(params, callback) {
  this.client.request('get', this.onePath + '/variables', params, callback);
};

Project.prototype.getVariable = function(params, callback) {
  this.client.request('get', this.onePath + '/variables/:key', params, callback);
};
